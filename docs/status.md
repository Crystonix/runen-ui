...
| Styling | partial | accepted production host-neutral style environment with typed themes/recipes/ordered variants, deterministic property-local precedence and exact provenance/diagnostics, canonical hover/focus/active/disabled projection, explicit high-contrast/reduced-motion preferences, bounded foreground/typography inheritance, metric typography, and effect-driven retained invalidation | broader visual property/composition/motion breadth belongs to M9 |
