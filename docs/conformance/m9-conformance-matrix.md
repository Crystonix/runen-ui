...
| M9VIS-08 | Ordinary drop shadows preserve exact neutral offset/sigma/signed-spread/color and deterministic logical effect bounds; shadows expand paint/damage only and do not silently alter layout/hit/focus/semantic bounds. | Shadow/effect-bounds corpus | Backend-default blur, invalid/collapsed-spread, clipped-shadow, and semantic/layout inflation audit | Effect-bound/realization diagnostics | M9A | blocked | Required |
